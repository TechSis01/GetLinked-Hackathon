...
function Partners() {
  return (
   <section className="flex flex-col text-white py-24 md:px-20 px-16 relative overflow-x-hidden">
    <img src={purple} alt="star" className="absolute partner-star1"></img>
    <img src={brightPurple} alt="star"  className="absolute partner-star2"></img>
    <img src={whiteStar} alt="star"  className="absolute partner-star3"></img>
